...
function UIMenu:UpdateScaleform()
    ...
    PushScaleformMovieFunctionParameterString(locale('btn_select'))
    PopScaleformMovieFunction()
    ...
    if self.Controls.Back.Enabled then
        ...
        PushScaleformMovieFunctionParameterString(locale('btn_back'))
        PopScaleformMovieFunction()
    end
    ...
    if self.Controls.Increment.Enabled and not tobool(Controller()) then
        ...
        PushScaleformMovieFunctionParameterString(locale('btn_increment')..(paginationValue and ': '..paginationValue or ": "..paginationValue))
        PopScaleformMovieFunction()
    end
