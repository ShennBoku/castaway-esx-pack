(function () {
    ...
    ESX_MENU.open = function (namespace, name, data) {
        ...
        document.onkeyup = function (key) {
            if (key.which === 27) {
                // Escape key
                SendMessage('kyg_fw', `${ESX_MENU.ResourceName}:menu_cancel`, data);
            } else if (key.which === 13) {
                // Enter key
                SendMessage('kyg_fw', `${ESX_MENU.ResourceName}:menu_submit`, data);
            }
        };
    ...
    ESX_MENU.change = function (namespace, name, data) {
        SendMessage('kyg_fw', `${ESX_MENU.ResourceName}:menu_change`, data);
    };
