...
local blackoutVehicle = cfgWeather.BlackoutVehicle
local disable = cfgWeather.Disabled
...
lib.callback.register('vSync:currentTime', function()
...
CreateThread(function()
    ...
    local timeIncrement = cfgWeather.RealTimeSync and 0.25 or 1
    ...
    while true do
        if not disable then
            ...
            if tick - (cfgWeather.RealTimeSync and 500 or 22) > tick then
