...
Config.Peds.Hash = {
	...
	['s_m_y_strvend_01'] = 0x927F2323, ['s_m_y_swat_01'] = 0x8D8F1B10, ['s_m_y_uscg_01'] = 0xCA0050E9, ['s_m_y_valet_01'] = 0x3B96F23E, ['s_m_y_waiter_01'] = 0xAD4C724C, ['s_m_y_winclean_01'] = 0x550D8D9D, ['s_m_y_xmech_01'] = 0x441405EC, ['s_m_y_xmech_02_mp'] = 0x69147A0D, ['s_m_y_xmech_02'] = 0xBE20FA04, ['u_f_m_corpse_01'] = 0x2E140314, ['u_f_m_drowned_01'] = 0xD7F37609, ['u_f_m_miranda'] = 0x414FA27B, ['u_f_m_promourn_01'] = 0xA20899E7, ['u_f_o_moviestar'] = 0x35578634, ['u_f_o_prolhost_01'] = 0xC512DD23, ['u_f_y_bikerchic'] = 0xFA389D4F, ['u_f_y_comjane'] = 0xB6AA85CE, ['u_f_y_corpse_01'] = 0x9C70109D, ['u_f_y_corpse_02'] = 0x0D9C72F8, ['u_f_y_hotposh_01'] = 0x969B6DFE, ['u_f_y_jewelass_01'] = 0xF0D4BE2E, ['u_f_y_mistress'] = 0x5DCA2528, ['u_f_y_poppymich'] = 0x23E9A09E, ['u_f_y_princess'] = 0xD2E3A284, ['u_f_y_spyactress'] = 0x5B81D86C, ['u_m_m_aldinapoli'] = 0xF0EC56E2, ['u_m_m_bankman'] = 0xC306D6F5, ['u_m_m_bikehire_01'] = 0x76474545, ['u_m_m_doa_01'] = 0x621E6BFD, ['u_m_m_edtoh'] = 0x2A797197, ['u_m_m_fibarchitect'] = 0x342333D3, ['u_m_m_filmdirector'] = 0x2B6E1BB6, ['u_m_m_glenstank_01'] = 0x45BB1666, ['u_m_m_griff_01'] = 0xC454BCBB, ['u_m_m_jesus_01'] = 0xCE2CB751, ['u_m_m_jewelsec_01'] = 0xACCCBDB6, ['u_m_m_jewelthief'] = 0xE6CC3CDC, ['u_m_m_markfost'] = 0x1C95CB0B, ['u_m_m_partytarget'] = 0x81F74DE7, ['u_m_m_prolsec_01'] = 0x709220C7, ['u_m_m_promourn_01'] = 0xCE96030B, ['u_m_m_rivalpap'] = 0x60D5D6DA, ['u_m_m_spyactor'] = 0xAC0EA5D8, ['u_m_m_streetart_01'] = 0x6C19E962, ['u_m_m_willyfist'] = 0x90769A8F, 
	['u_m_o_filmnoir'] = 0x2BACC2DB, ['u_m_o_finguru_01'] = 0x46E39E63, ['u_m_o_taphillbilly'] = 0x9A1E5E52, ['u_m_o_tramp_01'] = 0x6A8F1F9B, ['u_m_y_abner'] = 0xF0AC2626, ['u_m_y_antonb'] = 0xCF623A2C, ['u_m_y_babyd'] = 0xDA116E7E, ['u_m_y_baygor'] = 0x5244247D, ['u_m_y_burgerdrug_01'] = 0x8B7D3766, ['u_m_y_chip'] = 0x24604B2B, ['u_m_y_corpse_01'] = 0x94C2A03F, ['u_m_y_cyclist_01'] = 0x2D0EFCEB, ['u_m_y_fibmugger_01'] = 0x85B9C668, ['u_m_y_guido_01'] = 0xC6B49A2F, ['u_m_y_gunvend_01'] = 0xB3229752, ['u_m_y_hippie_01'] = 0xF041880B, ['u_m_y_imporage'] = 0x348065F5, ['u_m_y_juggernaut_01'] = 0x90EF5134, ['u_m_y_justin'] = 0x7DC3908F, ['u_m_y_mani'] = 0xC8BB1E52, ['u_m_y_militarybum'] = 0x4705974A, ['u_m_y_paparazzi'] = 0x5048B328, ['u_m_y_party_01'] = 0x36E70600, ['u_m_y_pogo_01'] = 0xDC59940D, ['u_m_y_prisoner_01'] = 0x7B9B4BC0, ['u_m_y_proldriver_01'] = 0x855E36A3, ['u_m_y_rsranger_01'] = 0x3C438CD2, ['u_m_y_sbike'] = 0x6AF4185D, ['u_m_y_staggrm_01'] = 0x9194CE03, ['u_m_y_tattoo_01'] = 0x94AE2B8C, ['u_m_y_zombie_01'] = 0xAC4B4506,
}

Config.Peds.Bone = {
    [0] = { name = 'NONE', label = 'Unknown' }, [31085] = { name = 'HEAD', label = 'Head' }, [31086] = { name = 'HEAD', label = 'Head' }, [39317] = { name = 'NECK', label = 'Neck' }, [57597] = { name = 'SPINE', label = 'Spine' }, [23553] = { name = 'SPINE', label = 'Spine' }, [24816] = { name = 'SPINE', label = 'Spine' }, [24817] = { name = 'SPINE', label = 'Spine' }, [24818] = { name = 'SPINE', label = 'Spine' }, [10706] = { name = 'UPPER_BODY', label = 'Upper Body' },
    [64729] = { name = 'UPPER_BODY', label = 'Upper Body' }, [11816] = { name = 'LOWER_BODY', label = 'Lower Body' }, [45509] = { name = 'LARM', label = 'Left Arm' }, [61163] = { name = 'LARM', label = 'Left Arm' }, [18905] = { name = 'LHAND', label = 'Left Hand' }, [4089] = { name = 'LFINGER', label = 'Left Finger' }, [4090] = { name = 'LFINGER', label = 'Left Finger' }, [4137] = { name = 'LFINGER', label = 'Left Finger' }, [4138] = { name = 'LFINGER', label = 'Left Finger' }, [4153] = { name = 'LFINGER', label = 'Left Finger' },
    [4154] = { name = 'LFINGER', label = 'Left Finger' }, [4169] = { name = 'LFINGER', label = 'Left Finger' }, [4170] = { name = 'LFINGER', label = 'Left Finger' }, [4185] = { name = 'LFINGER', label = 'Left Finger' }, [4186] = { name = 'LFINGER', label = 'Left Finger' }, [26610] = { name = 'LFINGER', label = 'Left Finger' }, [26611] = { name = 'LFINGER', label = 'Left Finger' }, [26612] = { name = 'LFINGER', label = 'Left Finger' }, [26613] = { name = 'LFINGER', label = 'Left Finger' }, [26614] = { name = 'LFINGER', label = 'Left Finger' },
    [58271] = { name = 'LLEG', label = 'Left Leg' }, [63931] = { name = 'LLEG', label = 'Left Leg' }, [2108] = { name = 'LFOOT', label = 'Left Foot' }, [14201] = { name = 'LFOOT', label = 'Left Foot' }, [40269] = { name = 'RARM', label = 'Right Arm' }, [28252] = { name = 'RARM', label = 'Right Arm' }, [57005] = { name = 'RHAND', label = 'Right Hand' }, [58866] = { name = 'RFINGER', label = 'Right Finger' }, [58867] = { name = 'RFINGER', label = 'Right Finger' }, [58868] = { name = 'RFINGER', label = 'Right Finger' },
    [58869] = { name = 'RFINGER', label = 'Right Finger' }, [58870] = { name = 'RFINGER', label = 'Right Finger' }, [64016] = { name = 'RFINGER', label = 'Right Finger' }, [64017] = { name = 'RFINGER', label = 'Right Finger' }, [64064] = { name = 'RFINGER', label = 'Right Finger' }, [64065] = { name = 'RFINGER', label = 'Right Finger' }, [64080] = { name = 'RFINGER', label = 'Right Finger' }, [64081] = { name = 'RFINGER', label = 'Right Finger' }, [64096] = { name = 'RFINGER', label = 'Right Finger' }, [64097] = { name = 'RFINGER', label = 'Right Finger' },
    [64112] = { name = 'RFINGER', label = 'Right Finger' }, [64113] = { name = 'RFINGER', label = 'Right Finger' }, [36864] = { name = 'RLEG', label = 'Right Leg' }, [51826] = { name = 'RLEG', label = 'Right Leg' }, [20781] = { name = 'RFOOT', label = 'Right Foot' }, [52301] = { name = 'RFOOT', label = 'Right Foot' },
}

Config.Peds.Appearance = {
    mp_m_freemode_01 = {
        model = 'mp_m_freemode_01',
        headBlend = {
            shapeFirst = 0, shapeSecond = 0, shapeMix = 0.0, -- Face
            skinFirst = 0, skinSecond = 0, skinMix = 0.0, -- Skin
            shapeThird = 0, skinThird = 0, thirdMix = 0.0, -- Race
        },
        faceFeatures = {
            -- Nose
            noseWidth = 0.0,
        ...
        headOverlays = {
            eyebrows = { style = 0, color = 0, secondColor = 0, opacity = 0 },
            makeUp = { style = 0, color = 0, secondColor = 0, opacity = 0.0 },
            blush = { style = 0, color = 0, secondColor = 0, opacity = 0.0 },
            lipstick = { style = 0, color = 0, secondColor = 0, opacity = 0.0 },
            beard = { style = 0, color = 0, secondColor = 0, opacity = 0 },
            blemishes = { style = 0, color = 0, secondColor = 0, opacity = 0 },
            ageing = { style = 0, color = 0, secondColor = 0, opacity = 0 },
            complexion = { style = 0, color = 0, secondColor = 0, opacity = 0 },
            sunDamage = { style = 0, color = 0, secondColor = 0, opacity = 0 },
            moleAndFreckles = { style = 0, color = 0, secondColor = 0, opacity = 0 },
            chestHair = { style = 0, color = 0, secondColor = 0, opacity = 0 },
            bodyBlemishes = { style = 0, color = 0, secondColor = 0, opacity = 0 },
        },
        eyeColor = -1,
        ...
        components = {
            ...
            { component_id = 2, drawable = 0, texture = 0 }, -- Hair
            { component_id = 3, drawable = 0, texture = 0 }, -- Hands
            { component_id = 4, drawable = 0, texture = 0 }, -- Legs
            { component_id = 5, drawable = 0, texture = 0 }, -- Bags and Parachute
            { component_id = 6, drawable = 0, texture = 0 }, -- Shoes
            { component_id = 7, drawable = 0, texture = 0 }, -- Scarf and Chains
            { component_id = 8, drawable = 0, texture = 0 }, -- Shirt
            { component_id = 9, drawable = 0, texture = 0 }, -- Body Armor
            { component_id = 10, drawable = 0, texture = 0 }, -- Decals
            { component_id = 11, drawable = 0, texture = 0 }, -- Jackets
        },
        props = {
            { prop_id = 0, drawable = -1, texture = -1 }, -- Hats and Helmets
            { prop_id = 1, drawable = -1, texture = -1 }, -- Glasses
            { prop_id = 2, drawable = -1, texture = -1 }, -- Ear
            { prop_id = 6, drawable = -1, texture = -1 }, -- Watches
            { prop_id = 7, drawable = -1, texture = -1 }, -- Bracelets
        },
        tattoos = {}
    },
...
Config.Peds.InfiniteStamina = true
Config.Peds.LookTalkingPlayer = true