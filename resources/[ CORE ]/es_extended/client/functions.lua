...
local addonResourcesState = {
    ['esx_progressbar'] = GetResourceState('kyg_fw') ~= 'missing',
    ['esx_notify'] = GetResourceState('kyg_fw') ~= 'missing',
    ['esx_textui'] = GetResourceState('kyg_fw') ~= 'missing',
    ['esx_context'] = GetResourceState('kyg_fw') ~= 'missing',
}
...
function ESX.Progressbar(message, length, options)
	return IsResourceFound('esx_progressbar') and exports.kyg_fw:Progressbar(message, length, options)
end

function ESX.CancelProgressbar()
    return IsResourceFound('esx_progressbar') and exports.kyg_fw:CancelProgressbar()
end
...
function ESX.ShowNotification(message, notifyType, length)
    lib.notify({ description = message, duration = length, type = notifyType, title = title })
end

function ESX.TextUI(...)
	return IsResourceFound('esx_textui') and exports.kyg_fw:TextUI(...)
end

---@return nil
function ESX.HideUI()
	return IsResourceFound('esx_textui') and exports.kyg_fw:HideUI()
end
...
function ESX.OpenContext(...)
    return IsResourceFound('esx_context') and exports.kyg_fw:OpenContext(...)
end

function ESX.PreviewContext(...)
    return IsResourceFound('esx_context') and exports.kyg_fw:PreviewContext(...)
end

function ESX.CloseContext(...)
    return IsResourceFound('esx_context') and exports.kyg_fw:CloseContext(...)
end

function ESX.RefreshContext(...)
    return IsResourceFound('esx_context') and exports.kyg_fw:RefreshContext(...)
end
